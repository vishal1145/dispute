      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            ...
            <br />
            <br />
            An email notification will be sent to the member's email address.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={handleCancel} disabled={sendingEmail}>Cancel</Button>
          <Button
          ...
          >
            {sendingEmail ? 'Sending Email...' : 'Confirm'}
          </Button>
        </DialogActions>
      </Dialog>
    </div>
